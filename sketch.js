...
function preload() {
	...
	warningtext = createElement('div');
	warningtext.addClass('warningtext');
	warningtext.parent(container);
	warningtextHTML = "<br><br>BDG-11 should work fine in Firefox and Chrome, but may not work in Safari.<br>";
	warningtext.html(warningtextHTML);
	
	credits = createElement('div');
	credits.addClass('credits');
	credits.parent(container);
	creditsHTML = "For use with the Crazy Circuits Invention Board from <a href=https://www.browndoggadgets.com/ target=_blank>Brown Dog Gadgets</a>.<br>";
	creditsHTML += "Original version by <a href=http://ericrosenbaum.com target=_blank>Eric Rosenbaum</a>, ";
...
function createHelpBoxes() {    
	...
	b = createHelpBox(250, -190, 
		'Play sounds', 
		'Use your Invention Board, use your computer keyboard, or click these keys');
	boxes.push(b);  
